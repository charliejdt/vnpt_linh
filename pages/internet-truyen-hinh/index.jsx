          ...
          <div className="rounded-xl text-right p-0 md:p-0 lg:p-0">
            <h2 className="text-lg md:text-xl lg:text-2xl ">
              <ul className=" py-2 md:py-4 md:p-4 border-main font-family:Arial gap-2 text-justify">
                <li>
                  &emsp; MyTV là dịch vụ truyền hình của VNPT, cung cấp hơn 180
                  kênh giải trí, tin tức, thể thao, phim ảnh và nhiều nội dung
                  đa dạng. Người dùng có thể xem trực tiếp, truy cập nội dung
                  theo yêu cầu và sử dụng các tính năng tiện ích như ghi lại,
                  dừng lại, tua nhanh. Với chất lượng hình ảnh và âm thanh cao
                  cấp, MyTV mang đến trải nghiệm giải trí tuyệt vời cho người
                  dùng. Dưới đây là bảng giá mới nhất:
                </li>
              </ul>
            </h2>
          </div>
