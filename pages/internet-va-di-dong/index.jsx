        ...
        <div className="rounded-xl text-right p-0 md:p-0 lg:p-0">
          <h2 className="text-lg md:text-xl lg:text-2xl ">
            <ul className=" py-2 md:py-4 md:p-4 border-main font-family:Arial gap-2 text-justify">
              <li>
                &emsp; VNPT Home Sành là gói cước internet và điện thoại của
                VNPT, không bao gồm dịch vụ truyền hình. Gói này cung cấp tốc độ
                internet cao và dịch vụ điện thoại đáng tin cậy để đáp ứng nhu
                cầu liên lạc và truy cập 4G của gia đình. VNPT Home Sành giúp
                người dùng trải nghiệm công nghệ tiện ích và đáng tin cậy tại
                nhà. Dưới đây là bảng giá mới nhất:
              </li>
            </ul>
          </h2>
        </div>
