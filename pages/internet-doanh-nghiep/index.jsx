          ...
          <h2 className="text-lg md:text-xl lg:text-2xl ">
            <ul className=" py-2 md:py-4 md:p-4 border-main font-family:Arial gap-2 text-justify">
              <li>
                ...
                Với tốc độ truy cập nhanh chóng, ổn định và tính năng tiện ích,
                các gói cước Internet VNPT năm 2023 hứa hẹn mang lại sự thuận
                tiện và hài lòng cho khách hàng. Dưới đây là bảng giá mới nhất:
              </li>
            </ul>
          </h2>
        </div>
                ...
                <div className="border-[1px]  lg:hover:-translate-y-4 transition-all text-center shadow-2xl pb-4 rounded-xl overflow-hidden">
                  ...
                  <div className="border-b-2 mx-0 md:mx-4 lg:mx-6 py-2 md:py-4 lg:py-6">
                    ...
                    {/* <span className="block font-normal italic">
                      Cam Kết tốc độ quốc tế tối thiểu {value.noidung}
                    </span> */}
                  </div>
                  ...
                  <div>
                    <ul className="p-2 md:p-4 lg:p-6 flex flex-col gap-2 text-left font-family:Arial text-xs md:text-sm lg:text-lg">
                      ...
                      <li>Tốc độ quốc tế tối thiểu: {value.noidung3}</li>
                      <li>Tốc độ quốc tế tối đa: {value.noidung4}</li>
                      {/* <li>Trang bị hạ tầng & modem Wifi</li>
                      <li>Đường truyền ổn định</li>
                      <li>Lắp đặt nhanh trong 24h</li> */}
                      <li className="text-red-600">Khuyến mãi 3 tháng cước</li>
                    </ul>
