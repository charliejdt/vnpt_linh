        ...
        <div className="rounded-xl text-right p-0 md:p-0 lg:p-0">
          <h2 className="text-lg md:text-xl lg:text-2xl ">
            <ul className=" py-2 md:py-4 md:p-4 border-main font-family:Arial gap-2 text-justify">
              <li>
                &emsp; VNPT cung cấp các gói cước combo ưu đãi: Gói VNPT Home
                Tiết Kiệm giúp khách hàng tiết kiệm chi phí với internet, truyền
                hình và điện thoại. Gói VNPT Home Đỉnh mang đến tốc độ internet
                cao và truyền hình chất lượng. Gói VNPT Home Kết Nối tạo kết nối
                linh hoạt với internet, truyền hình và điện thoại. Gói VNPT Home
                Thể Thao tập trung vào nội dung thể thao phong phú. Dưới đây là
                bảng giá mới nhất:
              </li>
            </ul>
          </h2>
