        ...
        <div className="rounded-xl text-right p-0 md:p-0 lg:p-0">
          <h2 className="text-lg md:text-xl lg:text-2xl ">
            <ul className=" py-2 md:py-4 md:p-4 border-main font-family:Arial gap-2 text-justify">
              <li>
                &emsp; VNPT Home Chất là dịch vụ gói cước cao cấp của VNPT, bao
                ...
                điện thoại đáng tin cậy, gói VNPT Home Chất mang đến trải nghiệm
                giải trí và liên lạc toàn diện cho gia đình. Dưới đây là bảng
                giá mới nhất:
              </li>
            </ul>
          </h2>
